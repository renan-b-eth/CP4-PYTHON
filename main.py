...
class Main:
    ...
    #evita o erro de maxima recursão de comparação = RecursionError
    ...
    lista3 = gerar_dados_testes(lista2, 3000, 1)
    ...
    def gerar_graficos(tempos):
        x = ["TEMPO BUBBLE", "TEMPO SELECTION", "TEMPO INSERTION", "TEMPO MERGE", "TEMPO QUICK"]
        y = [tempos["bubble_sort"], tempos["selection_sort"], tempos["insertion_sort"], tempos["mergeSort"], tempos["quickSort"]]
